...
$postsql = " INSERT INTO Post(user_id,title,post,category,image,approve,Sponsor)VALUES('$userid','$title','$post','$category','$image','$approve','$sponsor')";
...
if(empty($image)){
$postsql = " INSERT INTO Post(user_id,title,post,category,approve,Sponsor)VALUES('$userid','$title','$post','$category','$approve','$sponsor')";
$insertpost = mysqli_query($db,$postsql);
