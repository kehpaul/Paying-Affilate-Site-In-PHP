...
if(isset($_POST['approve'])){
  $approve = " UPDATE testimony SET approve='1' WHERE id='{$post_id}' ";
  $updateapprove = mysqli_query($db,$approve);
 $payment_type = 'Testimony';
$amount = '200';
$payment = "INSERT INTO payment_account(user_id,payment_type,amount)VALUES('$userid','$payment_type','$amount')";
$insertpayment = mysqli_query($db,$payment);
  }
...
margin:2.5%;
  ...
  $fetchpendpost = "SELECT * FROM testimony WHERE approve='0'";
